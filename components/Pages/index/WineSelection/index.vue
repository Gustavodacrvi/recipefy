<template>
  <div class="WineSelection landing-page-section">
    ...
    <DishSelection
      v-model="selected"
    />
    <WineScroller :res='response'/>
  </div>
</template>

<script>

import DishSelection from './DishSelection.vue'
import WineScroller from "@/components/Ui/Wine/WineScroller.vue"
